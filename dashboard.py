...
st.info("Pilih berkas CSV tdonasi_... dari komputer Anda")
...
# ==============================================
semua = []
st.info(f"📂 Membaca {len(berkas_list)} berkas...")
...
st.success(f"✅ SELESAI! Total {len(df):,} baris data")
st.markdown("---")
